...
if __name__ == "__main__":
	...
	status = filecmp.cmp("data/same-s1.txt","data/same-s2.txt")
	if status ==False:
		send_file_to_ftp_server("data/same-s1.txt", "/home/labuser/Assignment-1/data/")

		send_file_to_ftp_server("data/same-s2.txt", "/home/labuser/Assignment-1/data/")
